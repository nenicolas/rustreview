...
fn main() {
    ...
    for i in &rand_array {
        println!("rand_array values: {}", i);
    }

    let new_array = vec![0; bumber];
    println!("new_array values: {:?}", new_array);
...
// the "-> i32" means it returns a value of type an integer 
        //defined at 32 bit
